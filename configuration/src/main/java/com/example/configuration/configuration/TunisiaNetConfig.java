...
public class TunisiaNetConfig {
    ...
    @Bean
    @Transactional
    public Tiers getTunisiaNet() {
        Tiers tunisiaNetTiers = getOrCreateTiers("TunisiaNet");
        ...
        APIMethod apiMethod = getOrCreateAPIMethod(restAPIConfiguration, "GET", "/tunisia-net/products", "Content-Type: application/json");
    ...
    private void createFieldMappings(APIMethod apiMethod) {
        addFieldMapping(apiMethod, "name", "name");
